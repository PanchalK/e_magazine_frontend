...
import { Box, Heading, Table, Thead, Tr, Th, Tbody, Drawer,
  DrawerBody,
  DrawerFooter,
  DrawerHeader,
  DrawerOverlay,
                ...
                <DrawerBody>
                  <Stack spacing="24px">
                    <Box>
                      ...
                      <Input ref={MagazineCode} type="text" id="magazinecode" required/>
                    </Box>
                    <Box>
                    ...
                    <Box>
                      ...
                      <Input ref={ReleaseDate} type="text" id="releasedate" required/>
                      <DatePicker onChange={onChange} value={value} />
                    </Box>
                    <Box>
                      <FormLabel htmlFor="coverimg">Upload Cover Picture</FormLabel>
                      <Input type="file" ref={CoverImage} id="coverimg" />
                    </Box>
                    <Box>
                      <FormLabel htmlFor="magazine">Upload Magazine</FormLabel>
                      <Input type="file" ref={Magazine} id="magazine" />
                    </Box>
                  </Stack>
                </DrawerBody>
